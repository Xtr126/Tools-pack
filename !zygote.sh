...
NAME="Misc tools" #Package/Extension Name
...
SHORTDESC="misc tools by xtr, more to come" #Provide a short description about this package/extension

C_EXTNAME="Misc-tools" #For Specifing a custom name for your extension script ($NAME is used if not defined)
